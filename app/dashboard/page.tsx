        ...
        <section className="mb-8 rounded-[2rem] border border-green-500/25 bg-green-500/[0.06] p-6 md:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:justify-between">
            ...
            <div className="w-full lg:max-w-xl">
              ...
              <textarea data-testid="outreach-message" dir="rtl" value={message} onChange={event => setMessage(event.target.value)} rows={7} className="w-full rounded-2xl border border-white/15 bg-black/60 p-4 leading-7 outline-none [overflow-wrap:anywhere] focus:border-yellow-500" />
